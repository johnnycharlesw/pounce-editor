...
const commentsSB3ProjectPath = path.resolve(__dirname, '../fixtures/comments.pproj');
const commentsSB3NoDupeIds = path.resolve(__dirname, '../fixtures/comments_no_duplicate_id_serialization.pproj');
const variableReporterSB2ProjectPath = path.resolve(__dirname, '../fixtures/top-level-variable-reporter.sb2');
const topLevelReportersProjectPath = path.resolve(__dirname, '../fixtures/top-level-reporters.pproj');
const draggableSB3ProjectPath = path.resolve(__dirname, '../fixtures/draggable.pproj');
const originSB3ProjectPath = path.resolve(__dirname, '../fixtures/origin.pproj');
const originAbsentSB3ProjectPath = path.resolve(__dirname, '../fixtures/origin-absent.pproj');
